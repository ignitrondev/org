import{N as d,F as c}from"./Footer-BXOpJowa.js";const g=[{id:1,category:"story",categoryLabel:"💛 Our Story",date:"May 10, 2026",dateISO:"2026-05-10",title:"4 Years of LDR: The Story Behind IgnitronDev",excerpt:"IgnitronDev was not just built from code — it was built from distance, patience, and love. This is the story of Bima Adam Nugraha and Ririn Setiawati, co-founders and partners in life, who have been in a long-distance relationship since December 2021.",color:"#f38ba8",featured:!0},{id:2,category:"company",categoryLabel:"Company",date:"April 20, 2026",dateISO:"2026-04-20",title:"Introducing Our Co-Founder: Ririn Setiawati",excerpt:"Meet Ririn Setiawati, Co-Founder of IgnitronDev. Born on November 28, 2007 in Narmada, Lombok Barat — currently studying Nursing at Universitas Qamarul Huda Badaruddin Bagu (UNIQBHA). She is the heart and inspiration behind everything we build.",color:"#cba6f7",featured:!1},{id:3,category:"technology",categoryLabel:"Technology",date:"October 15, 2024",dateISO:"2024-10-15",title:"Top Technology Trends Shaping 2025",excerpt:"Explore the emerging technologies that will revolutionize industries in the coming year and how IgnitronDev is preparing for these changes.",color:"#89b4fa",featured:!1},{id:4,category:"innovation",categoryLabel:"AI & Innovation",date:"September 28, 2024",dateISO:"2024-09-28",title:"How AI is Transforming Our Solutions",excerpt:"Discover how artificial intelligence is being integrated into our products to deliver more efficient and intelligent solutions for our clients.",color:"#cba6f7",featured:!1},{id:5,category:"technology",categoryLabel:"Security",date:"August 5, 2024",dateISO:"2024-08-05",title:"Cybersecurity in the Age of IoT",excerpt:"Understanding the security challenges in an increasingly connected world and how we're addressing them in our solutions.",color:"#f38ba8",featured:!1},{id:6,category:"innovation",categoryLabel:"Data Analytics",date:"July 12, 2024",dateISO:"2024-07-12",title:"Transforming Data into Actionable Insights",excerpt:"Learn how our analytics platform helps businesses make data-driven decisions that improve efficiency and profitability.",color:"#fab387",featured:!1},{id:7,category:"company",categoryLabel:"Team",date:"June 18, 2024",dateISO:"2024-06-18",title:"Building a Culture of Innovation",excerpt:"How we foster creativity and innovation within our team to drive breakthrough solutions for our clients.",color:"#74c7ec",featured:!1},{id:8,category:"personal",categoryLabel:"🎵 Music & Life",date:"May 15, 2026",dateISO:"2026-05-15",title:"Kenapa Bima Adam Suka Musik Atmospheric Phonk, Nightdrive, dan Space Ambient",excerpt:"Bagi Bima Adam, musik atmospheric bukan sekadar genre — ini adalah tempat pulang. Dari coding malam, LDR, overthinking, hingga refleksi diri. Inilah cerita di balik playlist-nya.",color:"#a6e3a1",featured:!1,fullContent:!0}];function m(e){return e.fullContent?`
        <article class="blog-card blog-card-full" data-category="${e.category}" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="blog-card-accent" style="background: linear-gradient(90deg, ${e.color}, #89b4fa);"></div>
            <div class="blog-card-body">
                <div class="blog-card-meta">
                    <span class="blog-card-category" style="color: ${e.color}; border-color: ${e.color}40; background: ${e.color}15;">${e.categoryLabel}</span>
                    <time class="blog-card-date" itemprop="datePublished" datetime="${e.dateISO}">${e.date}</time>
                </div>
                <h2 class="blog-card-title blog-card-title-featured" itemprop="headline">${e.title}</h2>
                <p class="blog-card-excerpt" itemprop="description">${e.excerpt}</p>
        ...
        `:e.featured?`
        <article class="blog-card blog-card-featured" data-category="${e.category}" itemscope itemtype="http://schema.org/BlogPosting">
            <div class="blog-card-accent" style="background: linear-gradient(90deg, ${e.color}, #cba6f7);"></div>
            <div class="blog-card-body">
                <div class="blog-card-meta">
                    <span class="blog-card-category" style="color: ${e.color}; border-color: ${e.color}40; background: ${e.color}15;">
                        ${e.categoryLabel}
                    </span>
        ...
        `:`
    <article class="blog-card" data-category="${e.category}" itemscope itemtype="http://schema.org/BlogPosting">
        <div class="blog-card-accent" style="background: ${e.color};"></div>
        <div class="blog-card-body">
            <div class="blog-card-meta">
                <span class="blog-card-category" style="color: ${e.color}; border-color: ${e.color}20; background: ${e.color}10;">
                    ${e.categoryLabel}
                </span>
                <time class="blog-card-date" itemprop="datePublished" datetime="${e.dateISO}">${e.date}</time>
            </div>
            <h2 class="blog-card-title" itemprop="headline">${e.title}</h2>
            <p class="blog-card-excerpt" itemprop="description">${e.excerpt}</p>
            <div class="blog-card-footer">
    ...
    `}function u(){document.querySelectorAll(".blog-filter-btn").forEach(i=>{i.addEventListener("click",function(){document.querySelectorAll(".blog-filter-btn").forEach(t=>t.classList.remove("active")),this.classList.add("active");const a=this.getAttribute("data-filter"),l=document.querySelectorAll(".blog-card");let n=0;l.forEach(t=>{const r=a==="all"||t.getAttribute("data-category")===a;t.style.display=r?"flex":"none",r&&n++});const o=document.getElementById("blogEmpty");o&&(o.style.display=n===0?"flex":"none")})});const e=document.getElementById("newsletterForm");e&&e.addEventListener("submit",function(i){i.preventDefault(),this.querySelector('input[type="email"]').value;const a=this.querySelector("button");a.textContent="Subscribed!",a.disabled=!0,setTimeout(()=>{a.textContent="Subscribe",a.disabled=!1,this.reset()},3e3)})}const s=document.querySelector("#app");s&&(s.innerHTML=`
        ${d()}
        <main class="main-content">
            ${p()}
        </main>
        ${c()}
    `);u();function b(){const e=document.getElementById("nav"),i=document.getElementById("mobileToggle");e&&(window.addEventListener("scroll",()=>{window.scrollY>50?e.classList.add("scrolled"):e.classList.remove("scrolled")}),i&&i.addEventListener("click",()=>{const a=document.querySelector(".nav-links");a&&(a.classList.toggle("active"),i.classList.toggle("active"))}))}b();console.log("IgnitronDev Blog Initialized");
